...
public class Queen extends Piece {
    public Queen(int[] position, boolean white) {
    ...
    public List<Move> generateMoves(HashMap<String, Piece> board) {
        ...
        // checks which squares the queen can travel on its bottom column
        ...
        // checks which squares the queen can travel on its right row
        ...
        // checks which squares the queen can travel on its left row
        startX = this.position[0];
        startY = this.position[1];
        while (true) {
            int[] newPos = {startX - 1, startY};
        ...
        // checks which squares the queen can travel on its top column
        startX = this.position[0];
        startY = this.position[1];
        while (true) {
            int[] newPos = {startX, startY - 1};
        ...
        // checks which squares the queen can travel on bottom right diagonal
        startX = this.position[0];
        startY = this.position[1];
        while (true) {
        ...
        // checks which squares the queen can travel on top left diagonal
        startX = this.position[0];
        startY = this.position[1];
        while (true) {
            int[] newPos = {startX - 1, startY - 1};
        ...
        // checks which squares the queen can travel on bottom left diagonal
        startX = this.position[0];
        startY = this.position[1];
        while (true) {
            int[] newPos = {startX - 1, startY + 1};
        ...
        // checks which squares the queen can travel on top right diagonal
        startX = this.position[0];
        startY = this.position[1];
        while (true) {
            int[] newPos = {startX + 1, startY - 1};
